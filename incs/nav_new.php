        ...
        <script type="text/javascript">
            ...
            var observer = new MutationObserver(function(mutations, observer) {
                ...
                if (bodyHeight <= winHeight ) {
                    ...
                    $(".headerContainer-new").removeClass("headerUp");
                }
            });
            ...
            var lastScrollTop = 0;
            var delta = 5;
            var headerHeight = $(".headerContainer-new").outerHeight();
            var didScroll;
            ...
            function hasScrolled() {
                ...
                if (st > lastScrollTop && st > headerHeight){
                    // hide header
                    $(".headerContainer-new .dropdown").removeClass("visible");
                    setTimeout(function() {
                        $(".headerContainer-new").addClass("headerUp");
                    }, 200);
                    setTimeout(function() {
