...
<div class='widthWrapper admin-content-wrapper'>
    ...
    <form class="generalForm" id="postFrm" method="post" action="ambPost_action.php?PID=<?php echo $PID; ?>&AID=0">
        <div class="row">
            <div class="sm-twelve md-twelve lg-ten xl-eight leftCol">
            ...
            <div class="sm-twelve md-twelve lg-ten xl-eight leftCol">
                <div class="form-group">
                    <label>Preview Image (240 x 240 minimum)</label>
            ...
            <div class="sm-twelve md-twelve lg-ten xl-eight leftCol">
                <div class="form-group">
                    <label>Hero Image (1440 x 475 minimum)</label>
                    <div class="cropHeaderWrapper">
        ...
        <div class="textRight"><button type="button" class="btn btn-primary">Continue</button></div>
    </form>
        ...
        <div class="admin-content-block clearfix" id="content-block-01">
            <form class="generalForm">
                ...
                <div class="sm-twelve">
                    <div class="form-group">
                        <label for="firstName">Copy 1</label>
                            <textarea id="PostContent" name="PostContent" type=tinymce
                                      style="height:300px;"><?php echo $PostContent; ?></textarea>
                    </div>
                </div>
                <div class="sm-twelve lg-twelve xl-twelve leftCol marBottom30 marTop15">
                    <label class="inline"><input type="radio" checked="checked"> Image</label>
                    <label class="inline paddingX1"><input type="radio"> Slideshow</label>
                    <label class="inline"><input type="radio"> Video</label>
                </div>
            </div>
                <div class="row">
                <div class="sm-twelve lg-twelve xl-twelve leftCol marBottom30">
                    <div class="form-group pull-left" style="padding-right:30px;">
                        <label>Image 1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (1440 x 900 minimum)</label>
                        <div class="cropHeaderWrapper">
                ...
                <div class="row marTop30 marBottom30">
                    <div class="sm-twelve md-three leftCol textLeft">
                        <div>
                            <a class="remove-link" href="javascript:void(0)">remove block 1 &nbsp;&nbsp;&nbsp; (copy + image)</a>
                        </div>
                    </div><!--
                --><div class="sm-twelve md-nine rightCol textRight">
                        <button type="button" class="btn btn-text ">+ Add More Content</button>
                        <button type="button" class="btn btn-primary marginX1">Preview</button>
        ...
        <div class="admin-content-block clearfix" id="content-block-02">
            <form class="generalForm">
                <div class="row">
                <div class="sm-twelve">
                    <div class="form-group">
                        <label for="firstName">Copy 2</label>
                            <textarea id="PostContent" name="PostContent" type=tinymce
                                      style="height:300px;"><?php echo $PostContent; ?></textarea>
                    </div>
                </div><!--
                    --><div class="sm-twelve lg-twelve xl-twelve leftCol marBottom30 marTop15">
                    <label class="inline"><input type="radio"> Image</label>
                    <label class="inline paddingX1"><input type="radio" checked="checked"> Slideshow</label>
                    <label class="inline"><input type="radio"> Video</label>
                </div><!--
                ...
                <div class="sm-twelve md-three leftCol textLeft">
                    <div>
                        <a class="remove-link" href="javascript:void(0)">remove block 2 &nbsp;&nbsp;&nbsp; (copy + image)</a>
                    </div>
                </div><!--
                --><div class="sm-twelve md-nine rightCol textRight">
                    <button type="button" class="btn btn-text ">+ Add More Content</button>
        ...
        <div class="admin-content-block clearfix" id="content-block-03">
            <form class="generalForm">
                <div class="row">
                <div class="sm-twelve">
                    <div class="form-group">
                        <label for="firstName">Copy  3</label>
                            <textarea id="PostContent" name="PostContent" type=tinymce
                                      style="height:300px;"><?php echo $PostContent; ?></textarea>
                    </div>
                </div>
                <div class="sm-twelve lg-twelve xl-twelve leftCol marBottom30 marTop15">
                    <label class="inline"><input type="radio"> Image</label>
                    <label class="inline paddingX1"><input type="radio"> Slideshow</label>
                    <label class="inline"><input type="radio" checked="checked"> Video</label>
                </div>
            </div>
                <div class="row">
                <div class="sm-twelve lg-twelve xl-twelve leftCol marBottom30">
    ...
    <div class="row marTop30 marBottom30">
        <div class="sm-twelve md-three leftCol textLeft">
            <div>
                <a class="remove-link" href="javascript:void(0)">remove block 3 &nbsp;&nbsp;&nbsp; (copy + image)</a>
            </div>
        </div><!--
                --><div class="sm-twelve md-nine rightCol textRight">
            <button type="button" class="btn btn-text ">+ Add More Content</button>
        ...
        <div class="row marTop15">
            <?php if (isset($PID) && $PID != "") { ?>
                <button type="button" onclick="delAmbPost('<?php echo $PID; ?>');"
                        class="btn btn-sm btn-danger pull-left">Delete This Post
                </button>
            <?php } ?>
        </div>
</div>
...
<style>
    #croppicPostImg {
        width: 120px; /* MANDATORY */
        height: 120px; /* MANDATORY */
    ...
    #croppicPostHeroImg {
        width: 580px; /* MANDATORY */
        height: 191px; /* MANDATORY */
        position: relative; /* MANDATORY */
        /*margin: 20px auto 20px; JC JUNE 28 2015*/ margin: 0 0 1em 0;
        border: 1px solid rgba(0, 0, 0, 0.1);
        box-sizing: content-box;
    ...
    @media all and (max-width: 600px) {
        #croppicPostHeroImg {
            width: 290px; /* MANDATORY */
            height: 96px; /* MANDATORY */
            position: relative; /* MANDATORY */
            /*margin: 20px auto 20px; JC JUNE 28 2015*/ margin: 0 0 1em 0;
            border: 1px solid rgba(0, 0, 0, 0.1);
            box-sizing: content-box;
...
<script>
    ...
    var cropContainerPostHeroImg = {
        ...
        onAfterImgCrop: function () {
            $('.croppicPostHeroImg_croppedImg').attr("style", "width:288px");
        },
