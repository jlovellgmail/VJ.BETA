    ...
    <body>
        <div class="sdWrapper">
            <div class="sdContent">
                ...
                <?php include '/incs/ambassador.php'; ?>
		...
		foreach ($favorites as $favorite) {
			...
			if ($favorite->getVar("Type") == "P") {
				...
				$collName = strtolower($collectionName);
				$productImg = $product->getThumbnailUrl();
				$FproductImg = "http://virgiljames.com$productImg";
				$favTitle = $product->getName();
				$Style = str_replace(" ", "-", $favTitle);
				$producturl = "http://virgiljames.com/product/$Style/$PID";
				...
				if (preg_match("/$collName/", $eventName)) {
