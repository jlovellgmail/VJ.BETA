                                        ...
                                        <table class="generalTable no-bord nested nestedTableGroupParent">
                                            ...
                                            <tr class="vMid">
                                                <td class="w25p"><div class="checkLabelDisplay plusMinus">
                                                        ...
                                                        <label for="check_<?php echo $OrdID; ?>_label">&nbsp; <b>#<?php echo $OrdID; ?></b></label>
                                                    </div></td>
                                                <td class="w25p"><?php $Date; ?></td>
                                                <td class="w25p">$<?php echo $Total; ?></td>
                                                <td class="w25p"><a href="#" style="text-decoration:underline;">detailed order view</a></td>
                                            </tr>
                                        </table>
