...
<div class="bgWrapper shippingBgWrapper">
	<div class="widthWrapper">
		<div class="tableWrapper tableHeight">
			<div class="cellWrapper">
				<h2>Shipping Information</h2>
				<form class="shippingForm" action="whatever.php">
					<div class="shippingFormLeft lg-five">
				 ...
				 --><div class="shippingFormRight lg-five">
						...
						<label for="telep">Telephone:</label>
						<input class="fNameField" type="text" name="telephone" />
						<label for="telep">Shipping Notes:</label>
						<textarea name="shipping_notes"></textarea>
					</div>
					<a class="continueButton" href="payment.php">Continue to Payment</a>
				</form>
			</div>
		</div>
	</div>
