<h2 class="black caps marBottom30">Shipping Info</h2>
<form class="checkoutForm generalForm generalFormBlock" action="" method="post" id="cartship" name="cartship">
    <div class="row" id="shipAddrFormDet">
        ...
        --><div class="sm-twelve lg-four centerCol">
            ...
            <div id="SStateAJAXRes">
                <select name="State" id="stateShipField">
    ...
    <div class="row">
        <div class="sm-twelve lg-six"> <a class="caps black underline" href="#"><b>Back To Summary</b></a> </div><!--
        --><div class="sm-twelve lg-six textRight"> <a class="fillBtn" href="#"><b>Continue</b></a> </div>
    </div>
</form>