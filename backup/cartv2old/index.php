                                ...
                                <div class="lg-nine leftCol">
                                    ...
                                    <div class="row marTop30">
                                        <div class="sm-twelve lg-six">
                                            <a class="caps black underline" href="/shop.php"><b>Continue Shopping</b></a>
                                        </div><!--
                                        --><?php if ($cartExist) { ?><!--
                                            --><div class="sm-twelve lg-six textRight">
                                                <a class="fillBtn" href="<?php echo ($logedIn ? "shipping.php" : "javascript:openModal('modalCheckout')") ?>">Checkout</a>
                                            </div>
                                        <?php } else { ?><!--
                                            --><div class="sm-twelve lg-six textRight">
                                                <a class="fillBtn" href="/index.php">Home</a>
                                            </div>
                                        <?php } ?>
                                    </div>
                                </div><!--
                                --><div class="lg-three rightCol">
                                    <div class="textCenter cartSidebar lGrayWhiteGradient">  
                                        ...
                                        <span class="ital marBottom0">
                                            All Domestic Purchases Receive
                                        </span>
                                        ...
                                        <p>
                                            All purchases are shipped
                                            prepaid to your mailing
                                            address by UPS 2nd Day
                                            in the United States, or by
                                            expedited international
                                            carriers (DHL, FEDEX, etc.)
