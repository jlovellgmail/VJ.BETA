...
<div class="toggleDivGroup">
    <div class="toggleDivGroupItem toggleDivGroupDefault">                                
        ...
        <div class="clearfix buttonGroup cartBorderBottom marTop15 marBottom30">
            ...
            <button class="fillBtn grayBtn toggleDivGroupButton" data-id="addressChange">Choose Another Address</button>
            <button class="fillBtn grayBtn toggleDivGroupButton" data-id="addressNew">Add Another Address</button>
        </div>
        ...
        <form class="checkoutForm generalForm generalFormBlock" action="addAddr_Action.php?AddrID=<?php echo $AddrID; ?>&action=update" method="post" id="cartEditaddr" name="cartEditaddr">
            ...
            <div class="row cartBorderBottom marBottom30">
                <label><input type="checkbox" id="saveNewAddress" name="saveNewAddress" <?php if ($SaveAddrFlag){echo "checked=''";} ?>>
                    &nbsp; Save my <?php echo $addrTitle; ?> address for future orders</label>
            </div>
            <?php } ?>
            <div class="row">
                <div class="sm-twelve lg-six">
    ...
    <div class="toggleDivGroupItem" id="addressChange">
        <div class="row v-btm marBottom30">
            <div class="sm-twelve lg-nine v-btm">
                <h2 class="black caps">Choose Another <?php echo ucfirst($addrTitle); ?> Address</h2>
            </div><div class="sm-twelve lg-three textRight v-btm">
                <a href="#" class="caps underline toggleDivGroupItemClose"><b>close</b></a>
            </div>
        </div>                                        
        <div class="clearfix marBottom30 gridLined twoBy">
            <div class="row"><!--
                ...
                foreach ($AddressList as $Addr) {
                    ...
                    ?>">
                        <label>
                            <input class="fltL" type="radio" name="chooseAnotherAddress" id="chkBx_<?php echo $AddrID ?>" value="<?php echo $AddrID ?>">                               
        ...
        <div class="row marTop30">
            <div class="sm-twelve lg-six">
                <button class="fillBtn grayBtn toggleDivGroupButton" data-id="addressNew">Add Another <?php echo ucfirst($addrTitle); ?> Address</button>
            </div><!--
            --><div class="sm-twelve lg-six textRight">
                <a class="fillBtn" href="javascript:useSelectedAddr();"><b>Use this <?php echo ucfirst($addrTitle); ?> Address</b></a>
            </div>
        </div>    
    </div>
