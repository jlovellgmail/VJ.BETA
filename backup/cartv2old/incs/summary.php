        ...
        <div class="clearfix">
            ...
            if ($PaymMethod == "cc") {
                ...
                --><div class="marTop15 col posRel">
                    <div class="inlineTextField"><span><b>Cardholder:</b></span> <?php echo $CCHolder; ?></div>
                    <div class="inlineTextField"><span><b>Card Type:</b></span> Ending in <?php echo $CCLastDig; ?></div>
                    <div class="inlineTextField"><span><b>Card Expires:</b></span> <?php echo $CCExp; ?></div>
                </div>
            <?php } else if ($PaymMethod == "paypal") { ?>
...
<div class="row marTop30">
    <div class="sm-twelve sm-twelve lg-nine">
        <input type="checkbox" name="termAndCont" id="termAndCont"/> I have read and accept the <a class="underline" href="#">shipping and returns</a> policy.
    </div><!--
