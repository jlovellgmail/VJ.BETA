...
if (!$orderExist) {
    ...
    <div class="row">
        <div class="lg-eight leftCol">
            <div class="row">
                ...
                <h2 class="caps black ital marTop15 marBottom15">Order #<?php echo $Order->getOrdID(); ?></h2>
    ...
    <div class="row">
            ...
            <div class="sm-twelve">
                <div class="cartTableWrapper">
                    ...
                    <div class="row cartPriceRow">
                        ...
                        --><div class="subtotalPrice sm-four lg-two">$100.00</div>
                    </div>
                    <div class="row cartPriceRow">
        ...
        <div class="row marTop30">
            ...
            --><div class="sm-twelve sm-twelve lg-three textRight"><a class="fillBtn" href="javascript:printOrd('<?php echo $Order->getOrdID(); ?>');"><b>Print</b></a> </div>
        </div>
    </div>
<?php }
?>