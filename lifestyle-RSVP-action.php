...
$userEmail = "customerservice@virgiljames.com";
//$userEmail = "savvas@study.net";

$subject = "Virgil James Lifestyle - RSVP";
                    ...
                    <tr>
                        <td><!-- Head Links : BEGIN -->
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#000000" style=" -webkit-border-top-left-radius: 35px; -webkit-border-bottom-right-radius: 35px; -moz-border-radius-topleft: 35px; -moz-border-radius-bottomright: 35px; border-top-left-radius: 35px; border-bottom-right-radius: 35px;">
                                ...
                                <tr>
                                    <td style=" font-family: Proxima Nova, Arial, sans-serif; padding:15px 6% 0px 6%; color:#fff;"><span style="font-size:36px;">Hello Content Admin,</span></td>
                                </tr>
                                <tr>
                                    <td style="padding:15px 6% 0 6%; font-family: Proxima Nova, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #FFFFFF;"><span style="font-weight:bold;">' . $_POST['rsvp_name'] . '</span> has just sent an RSVP for ' . $_POST['EventName'] . '</td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding: 15px 6%;"><table cellspacing="0" cellpadding="0" border="0" width="100%" style="">
                                        <tr>
                                            ...
                                            <td valign="top" align="left" style="padding: 10px 0 10px 20px; font-family: Proxima Nova, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #ffffff; border-bottom: 1px solid #cccccc;">' . $_POST['rsvp_email'] . '</td>
                                        </tr>
                                        <tr>
                                           <td valign="top" align="left" style="padding: 10px 0 10px 20px; font-family: Proxima Nova, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #ffffff; font-weight: bold; text-align:right;"> Phone Number </td>
                                            <td valign="top" align="left" style="padding: 10px 0 10px 20px; font-family: Proxima Nova, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #ffffff;">' . $_POST['rsvp_tel'] . '</td>
                                        </tr>
                                        <tr>

                                            <td valign="top" align="left" style="padding: 10px 0 10px 20px; font-family: Proxima Nova, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #ffffff; font-weight: bold; text-align:right;"> # of Guests </td>
