...
<html class="no-js" lang="en">
    <head>
        ...
        <title><?php echo $Name; ?> | <?php echo $AmbassadorPost->getVar('Title'); ?></title>
        ...
        <meta name="description" content="Contact <?php echo $Name; ?> of Virgil James to learn more about our luxury handbags, bags and accessories. "/>
