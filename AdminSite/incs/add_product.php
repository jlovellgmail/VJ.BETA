...
<form method="post" id="addProductFrm" action="add_product_action.php?PID=<?php echo $PID; ?>" enctype="multipart/form-data">
    <div class="row">
        ...
        <div id="styleDiv" <?php if ($isEdit == 'false') { echo "style='display:none'"; } ?>>
        		<div class="col-xs-12 col-sm-4">
            		<div class="form-group">
        ...
        <div id="productDetailsDiv" <?php if ($isEdit == 'false') { echo "style='display:none'"; } ?>>
        		...
        		<div class="col-xs-6 col-sm-3">
            		<div class="form-group">
                		<label for="productDimensions">Width (inches / cm)</label><br />
                		<div class="row">
                    		<div class="col-xs-6">
                        		<small>Inches</small>
        		...
        		<div class="col-xs-12">
            		<div class="form-group">
                		...
                		<textarea class="form-control" rows="1" id="PrimaryMaterial" name="PrimaryMaterial" placeholder="Add Primary Material(s)"><?php echo $PrimaryMaterial; ?></textarea>
            		</div>
        		</div>
        		<div class="col-xs-12">
            		<div class="form-group">
    ...
    <div class="col-xs-12 mrg-t-15">
        <div class="form-group">
            ...
            <div id="ProductGalleryDiv" class="row set-col-15p">
