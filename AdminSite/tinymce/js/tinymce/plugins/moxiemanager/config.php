<?php
	...
	//$CrsID = $_COOKIE['CrsID'];
	//$RootCookie = $_COOKIE['MoxieManager'];
	$liveSiteRootPath = str_replace("\Admin","",$rootpath);

	// General
	$moxieManagerConfig['general.license'] = 'HCIH-FC5L-Z5BT-4M4X-LIMK-QPAT-USFV-ZF57';
	$moxieManagerConfig['general.hidden_tools'] = '';
	$moxieManagerConfig['general.disabled_tools'] = '';
	$moxieManagerConfig['general.plugins'] = 'AutoFormat,AutoRename,Uploaded';
	...
	// Filesystem
	//$moxieManagerConfig['filesystem.rootpath'] = $rootpath. '/uploadedImages/';
	$moxieManagerConfig['filesystem.rootpath'] =  $liveSiteRootPath. '\uploadedImages';
	...
	// Local filesystem
	$moxieManagerConfig['filesystem.local.wwwroot'] = $liveSiteRootPath;
	$moxieManagerConfig['filesystem.local.urlprefix'] = 'http://www.virgiljames.net';
