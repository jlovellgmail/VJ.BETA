...
<form id="ambProfileFrm" class="generalForm generalFormBlock" method="post" action="/ambassador/ambProfile_action.php?AID=<?php echo $AID; ?>">
    <h2 class="caps black">Basic Info</h2>
    <br />
    <!--<div class="row">
    ...
    <div class="row">
        ...
        --><div class="sm-twelve md-six">
            <h2 class='caps black'>Profile Preview Image</h2>
            <div class="cropHeaderWrapper">
    ...
    <br><br>
    <div class="row">
        <h2 class='caps black'>Profile Hero Image</h2>
        <div class="lg-twelve"><div class="flexImage" style="max-width:600px;"><div><?php if (isset($ProfileHeroImg) && $ProfileHeroImg != "") { ?><img id="img_imagePH" class="formImgPreview circle" src="<?php echo $ProfileHeroImg; ?>"><?php } else { ?><img id="img_imagePH" class="formImgPreview circle" src="http://placehold.it/1440x900"><?php } ?></div><?php if (isset($ProfileHeroImg) && $ProfileHeroImg != "") { ?><br /><a class="textBtn" href="javascript:delAmbassadorImage('<?php echo $AID; ?>', 'PH');"><small>Remove</small></a><?php } ?></div></div>
        </div>
    ...
    <div id="ambSlideshowDiv">
            <h2 class='caps black'>Profile Slideshow Images</h2>
