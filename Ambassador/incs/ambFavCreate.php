...
<div class="widthWrapper">
    <div class="tableWrapper">
        <div class="cellWrapper">
            <form id="FavFrm" class="generalForm" method="post" action="/ambassador/addCustomFavorite_action.php?FID=<?php echo $FID; ?>&AID=<?php echo $AID; ?>">
                <div class="clearfix">
                    <?php if (isset($FID) && $FID != "") { ?>	
                        <h6 class="fw-700 size6 black caps fltL">Edit this Favorite</h6><a class="fltR" href="ambassador/favorites.php">&lt; BACK TO LIST</a>  
                    <?php } else { ?>
                        <h6 class="fw-700 size6 black caps fltL">Add a Favorite</h6><a class="fltR" href="ambassador/favorites.php">&lt; BACK TO LIST</a>
                    <?php } ?>
                ...
                <div class="row">
                    ...
                    </div><div class="sm-twelve marTop30"><label>Item Image (Minimum size (300 X 300))</label>
