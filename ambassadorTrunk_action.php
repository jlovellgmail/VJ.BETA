...
$subject = "Virgil James - Trunk Show Request";
...
<html lang="en">
    ...
    <title>Virgil James - Ambassador - Trunk Show Request</title>
                    ...
                    <tr>
                        <td><!-- Head Links : BEGIN -->
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#000000" style=" -webkit-border-top-left-radius: 35px; -webkit-border-bottom-right-radius: 35px; -moz-border-radius-topleft: 35px; -moz-border-radius-bottomright: 35px; border-top-left-radius: 35px; border-bottom-right-radius: 35px;">
                                ...
                                <tr>
                                    <td style="padding:15px 6% 0 6%; font-family: Proxima Nova, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #FFFFFF;"><span style="font-weight:bold;">' . $_POST['Name'] . '</span> has expressed interest in setting up a Virgil James Trunk Show. </td>
                                </tr>
                                <!-- Full Width, Fluid Column : END --> 
                                
                                <!-- Data Table : BEGIN -->
                                <tr>
                                    <td style="padding: 15px 6%;"><table cellspacing="0" cellpadding="0" border="0" width="100%" style="">
                                            <tr>
                                            <td valign="top" align="left" style="padding: 10px 0 10px 20px; font-family: Proxima Nova, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #ffffff; font-weight: bold; border-bottom: 1px solid #cccccc; text-align:right;"> Telephone </td>
                                            <td valign="top" align="left" style="padding: 10px 0 10px 20px; font-family: Proxima Nova, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #ffffff; border-bottom: 1px solid #cccccc;">' . $_POST['Telephone'] . '</td>
                                        </tr>
                                            <tr>
                                            ...
                                            <tr>
                                            <td valign="top" align="left" style="padding: 10px 0 10px 20px; font-family: Proxima Nova, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #ffffff; font-weight: bold; border-bottom: 1px solid #cccccc; text-align:right;"> Location </td>
                                            <td valign="top" align="left" style="padding: 10px 0 10px 20px; font-family: Proxima Nova, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #ffffff; border-bottom: 1px solid #cccccc;">' . $_POST['Location'] . '</td>
                                        </tr>
                                            <tr>
                                            <tr>
                                            <td valign="top" align="left" style="padding: 10px 0 10px 20px; font-family: Proxima Nova, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #ffffff; font-weight: bold; text-align:right;"> Comments </td>
                                            <td valign="top" align="left" style="padding: 10px 0 10px 20px; font-family: Proxima Nova, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #ffffff;">' . $_POST['Comments'] . '</td>
                                        </tr>
                                        </table></td>
                                </tr>
                                <!-- Data Table : END --> 
...
echo "<p class='textCenter black'><b>Your Trunk Show request has been sent successfully.</b></p>";
?>